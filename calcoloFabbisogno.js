...
document
  .getElementById("foodCalculatorForm")
  .addEventListener("submit", function (event) {
    ...
    if (metodoInput === "kcal") {
      calorieCrocchette = parseFloat(
        document.getElementById("kcalPerKg").value
      );
    } else {
      ...
      const carboidrati = parseFloat(
        document.getElementById("carboidrati").value
      );
    ...
    const razzaIncline = parseFloat(
      document.getElementById("razzaIncline").value
    );
    fabbisognoCalorico *= razzaIncline;

    // Considerare la sterilizzazione (ridurre le calorie del 10% se sterilizzato)
    const sterilizzato =
      document.getElementById("sterilizzato").value === "true";
    if (sterilizzato) {
    ...
    const condizioniMediche =
      document.getElementById("condizioniMediche").value;
    ...
    document.getElementById(
      "result"
    ).innerHTML = `${nomeDoggo} dovrebbe mangiare circa <p style="font-size: 23px!important; color: #b57fdb!important;">${crocchettePerGiorno.toFixed(
      0
    )}g </p> di crocchette al giorno.`;
    document.getElementById("result").style.display = "block";

    document.getElementById(
      "pasti"
    ).innerHTML = `2 pasti da <p style="font-size: 23px!important; color: #b57fdb!important;">${duePastiAlGiorno.toFixed(
      0
    )}g</p><br>
                                             3 pasti da <p style="font-size: 20px!important; color: #b57fdb!important;">${trePastiAlGiorno.toFixed(
                                               0
                                             )}g</p>`;
    ...
    document.getElementById(
      "additionalInfo"
    ).innerHTML = `il Fabbisogno Energetico di ${nomeDoggo} è <br> <p style="font-size: 23px!important; color: #b57fdb!important;">${fabbisognoCalorico.toFixed(
      0
    )} kcal / giorno</p>`;
